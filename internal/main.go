...
import (
	...
	"github.com/zherbert-dev/go-rest-api-example/pkg/swagger/server/restapi"

	"github.com/zherbert-dev/go-rest-api-example/pkg/swagger/server/restapi/operations"
)
